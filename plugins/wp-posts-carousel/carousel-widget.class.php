        ...
        <div>
            <fieldset style="padding:10px;">
                ...
                <p>
                    ...
                    <textarea class="widefat wp-posts-carousel-field field-validate" id="<?php echo $this->get_field_id("exclude"); ?>" name="<?php echo $this->get_field_name("exclude"); ?>" pattern="^[1-9](0*)(,?[1-9](0*))*$"><?php echo esc_attr($instance["exclude"]); ?></textarea>
                </p>
