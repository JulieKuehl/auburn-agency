...
//		wp_enqueue_script( 'auburnagency-js-extras' );
		...
		// Load jQuery for flexslider
		wp_register_script(
			'auburnagency-flexslider',
			get_stylesheet_directory_uri() . '/js/jquery.flexslider.js',
			array( 'jquery' )
		);
		wp_enqueue_script( 'auburnagency-flexslider' );
		// Load styles for flexslider
		wp_enqueue_style( 'auburnagency-flexslider', get_stylesheet_directory_uri() . '/css/flexslider.css' );
